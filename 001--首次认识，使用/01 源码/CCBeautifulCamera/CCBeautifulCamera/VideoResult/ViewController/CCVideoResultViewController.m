...
#import "CCVideoResultViewController+Private.h"
#import "CCVideoResultViewController.h"

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wincomplete-implementation"

@implementation CCVideoResultViewController
...
- (void)showPreview {
    ...
    UIImage *previewImage = [CCAssetHelper videoPreviewImageWithURL:url];
...
- (void)confirmAction:(id)sender {
    ...
    if (self.videos.count == 1) {
        ...
        NSString *exportPath = [CCFileHelper randomFilePathInTmpWithSuffix:@".m4v"];
        [CCAssetHelper mergeVideos:videoPaths toExportPath:exportPath completion:^{
