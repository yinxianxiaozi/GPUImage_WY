...
#import "CCCameraViewController+UI.h"
...
@implementation CCCameraViewController (UI)
...
- (void)setupCameraView {
    ...
    [self refreshCameraViewWithRatio:[CCCameraManager shareManager].ratio];
...
- (void)setupCapturingButton {
    self.capturingButton = [[CCCapturingButton alloc] init];
...
- (void)setupFilterBarView {
    self.filterBarView = [[CCFilterBarView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height, self.view.frame.size.width, 0)];
...
- (void)setupCameraTopView {
    self.cameraTopView = [[CCCameraTopView alloc] init];
...
- (void)setupModeSwitchView {
    self.modeSwitchView = [[CCCapturingModeSwitchView alloc] init];
...
- (void)setupRatioBlurView {
    self.ratioBlurView = [[CCVisualEffectView alloc] init];
...
- (void)setupVideoTimeLabel {
    self.videoTimeLabel = [[CCCameraVideoTimeLabel alloc] init];
