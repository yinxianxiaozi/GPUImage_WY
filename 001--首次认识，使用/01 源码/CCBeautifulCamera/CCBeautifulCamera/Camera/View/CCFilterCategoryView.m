...
@interface CCFilterCategoryView () <UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation CCFilterCategoryView
...
- (void)commonInit {
    ...
    [_collectionView registerClass:[CCFilterCategoryCell class] forCellWithReuseIdentifier:kFilterCategoryReuseIdentifier];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CCFilterCategoryCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:kFilterCategoryReuseIdentifier forIndexPath:indexPath];
