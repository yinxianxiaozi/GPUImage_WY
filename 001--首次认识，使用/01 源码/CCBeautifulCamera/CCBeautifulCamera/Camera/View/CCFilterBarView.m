...
#import "CCFilterCategoryView.h"

#import "CCFilterMaterialView.h"

static CGFloat const kFilterMaterialViewHeight = 100.0f;

@interface CCFilterBarView () <CCFilterMaterialViewDelegate, CCFilterCategoryViewDelegate>

@property (nonatomic, strong) CCFilterMaterialView *filterMaterialView;
@property (nonatomic, strong) CCFilterCategoryView *filterCategoryView;
@property (nonatomic, strong) UISwitch *beautifySwitch;
@property (nonatomic, strong) UISlider *beautifySlider;

@end

@implementation CCFilterBarView
...
- (void)setupFilterCategoryView {
    self.filterCategoryView = [[CCFilterCategoryView alloc] init];
...
- (void)setupFilterMaterialView {
    self.filterMaterialView = [[CCFilterMaterialView alloc] init];
...
- (void)setDefaultFilterMaterials:(NSArray<CCFilterMaterialModel *> *)defaultFilterMaterials {
...
- (void)setDefineFilterMaterials:(NSArray<CCFilterMaterialModel *> *)defineFilterMaterials {
...
#pragma mark - CCFilterMaterialViewDelegate
...
#pragma mark - CCFilterCategoryViewDelegate

- (void)filterCategoryView:(CCFilterCategoryView *)filterCategoryView didScrollToIndex:(NSUInteger)index {
