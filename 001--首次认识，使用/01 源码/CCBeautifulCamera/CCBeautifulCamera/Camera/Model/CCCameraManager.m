...
static CCCameraManager *_cameraManager;

@interface CCCameraManager ()

@property (nonatomic, strong, readwrite) GPUImageStillCamera *camera;
@property (nonatomic, weak) GPUImageView *outputView;
@property (nonatomic, strong, readwrite) CCFilterHandler *currentFilterHandler;
...
- (void)setupMovieWriter {
    NSString *videoPath = [CCFileHelper randomFilePathInTmpWithSuffix:@".m4v"];
...
- (void)setupFilterHandler {
    self.currentFilterHandler = [[CCFilterHandler alloc] init];
    // 添加效果滤镜
