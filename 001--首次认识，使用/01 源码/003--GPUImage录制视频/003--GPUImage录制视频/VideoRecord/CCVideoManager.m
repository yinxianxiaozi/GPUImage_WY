...
@interface CCVideoManager ()<GPUImageVideoCameraDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
static CCVideoManager *_manager;
...
-(void)changeCameraPosition:(CCVideoManagerCameraType)type {
    ...
    switch (type) {
        case CCVideoManagerCameraTypeFront:{
            [_videoCamera rotateCamera];
        }
            break;
        case CCVideoManagerCameraTypeBack:{
            [_videoCamera rotateCamera];
        }
            break;
